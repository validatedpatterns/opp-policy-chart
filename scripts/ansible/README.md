...
- **odf-ssl-certificate-extraction.yml** – Extract CAs from hub and managed clusters, build combined bundle, update hub/managed ConfigMaps and ramen-hub-operator-config, restart ramen/Velero pods.
